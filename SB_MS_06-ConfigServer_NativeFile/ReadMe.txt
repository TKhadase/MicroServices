...
Run SB_MS_06-ConfigServer_NativeFile project as spring boot application.

Run SB_MS_06-MS01-BankPaymentService project as Spring Boot Application refresh the Eureka server console
