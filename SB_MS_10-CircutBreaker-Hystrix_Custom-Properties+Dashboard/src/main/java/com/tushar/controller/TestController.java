...
public class TestController {
	...
	@HystrixCommand(fallbackMethod = "fallbackGetHome",
										...
										@HystrixProperty(name = "circuitBreaker.requestVolumeThreshold", value = "5"), //exception count
										@HystrixProperty(name = "circuitBreaker.sleepWindowInMilliseconds", value = "10000")//retry sleep time
										})
